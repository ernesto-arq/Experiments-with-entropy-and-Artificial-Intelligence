# -*- coding: utf-8 -*-
"""getDtasetCifar100.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1m0lpHCg-lXjSuFa89XNpjbg-NDEHAips
"""
...
def get_dataset_cifar100_extr_noniid(num_users, n_class, nsamples, rate_unbalance):
    ...
    apply_transform = transforms.Compose(
        [transforms.ToTensor(),
         transforms.Normalize((0.5071, 0.4867, 0.4408), (0.2675, 0.2565, 0.2761))]) # Normalization values for CIFAR100
...
def cifar_extr_noniid(train_dataset, test_dataset, num_users, n_class, num_samples, rate_unbalance):
    ...
    num_classes = 100 # Updated to CIFAR100's class count
