...
# Executando o código
train_dls, test_dls = get_MNIST(type="iid", n_samples_train=200, n_samples_test=100, n_clients=3, batch_size=25, shuffle=True)
images, labels = next(iter(train_dls[0]))
plot_samples((images, labels), channel=0, title="Amostras do primeiro cliente")